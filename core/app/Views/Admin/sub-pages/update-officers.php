                    ...
                    <div class="mt-5">
                        ...
                        <div class="card mb-5">
                            <div class="card-header border-0 py-4">
                                <small>UPDATE OFFICER'S IMAGE <span class="text-danger fw-bold">*</span></small>
                            </div>
                            <div class="card-body px-4">
                                <form action="<?= base_url('/admin/manage/page/officers/update/image') ?>" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                            ...
                                            <div class="d-block d-md-flex gap-3">
                                                <div class="user-content">
                                                    <div class="avatar-image">
                                                        <img src="<?= base_url('/assets/home/images/officers/'. $data["get_officers"][0]->image.'') ?>" alt="" srcset="">
                                                    </div>
                                                </div>
                                    ...
                                    <div class="action d-flex justify-content-end mt-3">
                        ...
                        <div class="card mb-5">
                            ...
                            <div class="card-body px-4">
                                <form action="<?= base_url('/admin/manage/page/officers/update/data') ?>" method="post">
                                    <div class="row">
                                        <input type="hidden" name="id" value="<?= $data["get_officers"][0]->id ?>">
