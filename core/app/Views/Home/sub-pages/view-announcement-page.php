        ...
        <div class="container py-5">
            <div class="section-title-left" data-aos="fade-up">
                <div class="section-main">
                    ...
                    <p>Get up to speed on the latest notifications or recent updates.</p>
                </div>
            </div>
            <hr>
            <div class="row my-5">
                    ...
                    if(!empty($data['site_announcements'])) {
                        ...
                        <nav aria-label="breadcrumb" class="mb-3">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="'.base_url('/bulletin/announcement/page/1').'" class="text-link">Announcements</a></li>
                                ...
                                <div class="redirect-page" data-src="'.base_url('/bulletin/news/'.$value->id.'/'.$title.'').'">
                                    <div class="d-flex align-items-center gap-0 gap-md-3 mb-2 news-content" data-aos="fade-up">
                                        <div class="news-image pe-3 pe-md-0">
                                            <img src="'.base_url('/assets/home/images/bulletin/announcements/'.$value->image.'').'" alt="announcement">
                                        </div>
                        ...
                        if($total_page > 1) {
                            if($current_page == 1) {
                                ...
                                <div class="action d-flex gap-3 justify-content-center mt-5">
                                    <a href="'.base_url('/bulletin/announcement/page/'.($current_page + 1).'').'" class="btn-custom btn-custom-outline text-link d-flex align-items-center gap-1">Next <i class="bx bxs-chevrons-right" style="margin-top: 2px"></i></a>
                                </div>
                                ';
                            } else if($current_page == $total_page) {
                                echo '
                                <div class="action d-flex gap-3 justify-content-center mt-5">
                                    <a href="'.base_url('/bulletin/announcement/page/'.($current_page - 1).'').'" class="btn-custom btn-custom-outline text-link d-flex align-items-center gap-1"><i class="bx bxs-chevrons-left" style="margin-top: 2px"></i>Prev</a>
                                </div>
                                ';
                            } else {
                                echo '
                        ...
                        <nav aria-label="breadcrumb" class="mb-3">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="'.base_url('/home').'" class="text-link">Home</a></li>
                                <li class="breadcrumb-item"><a href="'.base_url('/bulletin').'" class="text-link">Bulletin</a></li>
                                <li class="breadcrumb-item"><a href="'.base_url('/bulletin/announcement/page/1').'" class="text-link">Announcement</a></li>
