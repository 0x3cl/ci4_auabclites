    <div id="footer">
        ...
        <div class="footer-outer">
            <div class="container py-3">
                <ul class="list-inline">
                    <li class="list-inline-item">
                        <a href="https://www.arellano.edu.ph/" class="text-link" target="_blank">Arellano University</a>
                    </li>
                    <li class="list-inline-item">
                    ...
                    <li class="list-inline-item">
                        <a href="<?= base_url('/developers') ?>" class="text-link">Developers</a>
                    </li>
                </ul>
...
<script type="module" src="<?= base_url('/assets/home/libraries/js/app.js') ?>"></script>
</html>